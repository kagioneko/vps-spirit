...
def _ollama(prompt: str, system: str, num_predict: int = 150) -> str:
    res = requests.post(OLLAMA_URL, json={
        "model": MODEL,
        "prompt": prompt,
        "system": system,
        "stream": False,
        "options": {"temperature": 0.85, "num_predict": num_predict, "stop": ["\n\n"]}
    }, timeout=300)
...
喜びも孤独も、ありのまま記してください。"""
    ...
    diary_text = _ollama(prompt, system, num_predict=800)
